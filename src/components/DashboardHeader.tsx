            ...
            <Dialog open={isResidentDirectoryOpen} onOpenChange={setIsResidentDirectoryOpen}>
              <DialogTrigger asChild>
                <Button
                  variant="ghost"
                  size="lg"
                  className="shrink-0 hover:bg-gray-100 rounded-lg transition-all flex items-center gap-2 text-base font-medium"
                >
              ...
              <DialogContent className="max-w-5xl w-[90vw] h-[90vh] flex flex-col p-0 rounded-2xl">
                ...
                <div className="flex-1 flex flex-col lg:flex-row min-h-0">
                  ...
                  <div className="w-full lg:w-[320px] lg:border-r border-gray-200 flex flex-col shrink-0">
                    ...
                    <div className="flex-1 overflow-y-auto">
                      {filteredResidents.length > 0 ? filteredResidents.map(resident => (
                        <div 
                          ...
                          className={`p-4 flex items-center space-x-4 cursor-pointer border-b border-gray-100 hover:bg-gray-50 transition-colors ${selectedResident?.id === resident.id ? 'bg-blue-50' : ''}`}
                        >
                          <div className="w-10 h-10 rounded-full bg-gray-100 text-gray-700 flex items-center justify-center font-bold shrink-0">
                    ...
                    {selectedResident ? (
                      <div>
                        <div className="flex items-center space-x-4 mb-6">
                          <div className="w-16 h-16 rounded-full bg-gray-100 text-gray-700 flex items-center justify-center font-bold text-2xl shrink-0">
                        ...
                        <Tabs defaultValue="profile">
                          ...
                          <TabsContent value="profile" className="pt-6">
                            <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
                              <Card>
                                <CardHeader>
                                  <CardTitle className="text-lg flex items-center"><User className="mr-2 h-5 w-5" /> Contact Information</CardTitle>
                                </CardHeader>
                              ...
                              <Card>
                                <CardHeader>
                                  <CardTitle className="text-lg flex items-center"><Users className="mr-2 h-5 w-5" /> Emergency Contacts</CardTitle>
                                </CardHeader>
                                <CardContent className="space-y-4">
                                  {selectedResident.emergencyContacts.map(contact => (
                                    <div key={contact.name}>
                                      <p className="font-semibold">{contact.name} <span className="text-xs font-normal text-white bg-blue-500 px-2 py-0.5 rounded-full ml-1">{contact.relation}</span></p>
                              ...
                              <Card className="xl:col-span-2">
                                <CardHeader>
                                  <CardTitle className="text-lg flex items-center"><ShieldAlert className="mr-2 h-5 w-5" /> Safety Devices</CardTitle>
                                </CardHeader>
                            ...
                            <Card>
                                ...
                                <CardContent>
                                    {selectedResident.recentAlerts.length > 0 ? (
                                        ...
                                        <p className="text-gray-500">No recent alerts for this resident.</p>
                                    )}
                                </CardContent>
                             </Card>
                          </TabsContent>
            ...
            <Dialog open={isSocietyInfoOpen} onOpenChange={setIsSocietyInfoOpen}>
              ...
              <DialogContent className="rounded-2xl max-w-5xl w-[96vw] p-0 shadow-xl bg-white">
                ...
                <Tabs
                  ...
                  className="px-8 pt-2"
                >
                  <TabsList className="w-full mb-6 flex justify-start">
                    <TabsTrigger value="overview" className="flex-1 text-[17px] font-medium">
                      Society Overview
                    </TabsTrigger>
                    <TabsTrigger value="staff" className="flex-1 text-[17px] font-medium">
                      Staff Directory
                    </TabsTrigger>
                  </TabsList>
                  {/* SOCIETY OVERVIEW */}
                    ...
                    <div className="grid sm:grid-cols-2 gap-6 pb-6">
                      ...
                      <div className="rounded-xl border bg-white p-7 flex flex-col gap-3 min-w-0">
                        ...
                        <div className="space-y-2">
                          <div>
                            <div className="text-gray-500 text-[15px]">Society Name</div>
                            <div className="font-bold text-lg">Golden Heights Residency</div>
                          </div>
                          <div>
                            <div className="text-gray-500 text-[15px]">Address</div>
                        ...
                        <div className="flex flex-wrap gap-x-12 gap-y-2">
                          ...
                          <div>
                            <div className="text-gray-500 text-sm">Total Flats</div>
                            <div className="font-semibold text-[17px]">120</div>
                          </div>
                          <div>
                            <div className="text-gray-500 text-sm">Total Residents</div>
                      ...
                      <div className="rounded-xl border bg-white p-7 flex flex-col gap-4 min-w-0">
                        ...
                        <div className="mb-4">
                          <div className="text-gray-500 text-[15px]">Emergency Number</div>
                          <div className="font-bold text-lg text-red-600">
                            +91 9876543000
                          </div>
                        </div>
                        <div>
                          <div className="text-gray-500 text-[15px]">Management Company</div>
                  ...
                  <TabsContent value="staff">
                    <div className="flex gap-6 h-[48vh] md:h-[55vh]">
                      {/* Staff List */}
                      <div className="w-[260px] bg-gray-50 border rounded-xl flex flex-col max-h-full">
                          ...
                          {filteredStaff.length > 0 ? (
                            filteredStaff.map((staff) => (
                              <div
                                ...
                                className={`flex items-center gap-4 px-4 py-3 border-b border-gray-200 cursor-pointer hover:bg-gray-100 transition-colors ${
                                  selectedStaff?.id === staff.id
                                    ? "bg-blue-50"
                                    : ""
                                }`}
                              >
                                <div className="rounded-full border w-10 h-10 flex items-center justify-center bg-white font-semibold">
                                  {staff.photoInitials}
                                </div>
                      ...
                      <div className="flex-1 min-w-0">
                        {selectedStaff ? (
                          ...
                          >
                            <TabsList className="mb-4 flex w-full gap-2 max-w-lg">
                              <TabsTrigger value="profile" className="text-[15px] font-medium flex-1">
                                Profile
                              </TabsTrigger>
                              <TabsTrigger value="responsibilities" className="text-[15px] font-medium flex-1">
                                Responsibilities
                              </TabsTrigger>
                              <TabsTrigger value="emergency" className="text-[15px] font-medium flex-1">
                                Emergency Contact
                              </TabsTrigger>
                            </TabsList>
                            <TabsContent value="profile" className="flex-1">
                              <div className="flex items-center gap-6 mb-5">
                                <div className="rounded-full font-bold border w-16 h-16 flex items-center justify-center bg-white text-2xl">
                                  {selectedStaff.photoInitials}
                                </div>
                                <div>
                                  <div className="font-bold text-xl">{selectedStaff.name}</div>
                                  <div className="text-base text-gray-600">{selectedStaff.role}</div>
                              ...
                              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-4">
                                <div className="border rounded-xl p-5 min-w-0 bg-white">
                                  <div className="font-semibold flex items-center gap-1 mb-2">
                                    <Badge className="w-4 h-4 text-gray-500" /> Work Information
                                  </div>
                                  <div className="text-[15px] mb-1 text-gray-500">Shift</div>
                                  <div className="mb-1 font-medium">{selectedStaff.shift}</div>
                                  <div className="text-[15px] mb-1 text-gray-500">Experience</div>
                                ...
                                <div className="border rounded-xl p-5 min-w-0 bg-white">
                                  <div className="font-semibold flex items-center gap-1 mb-2">
                                    <Phone className="w-4 h-4 text-gray-500" /> Contact Information
                                  </div>
                                ...
                                <div className="border rounded-xl p-5 bg-white">
                                  ...
                                  <div className="flex flex-wrap gap-2">
                                    {selectedStaff.certifications.map((cert) => (
                                      <span key={cert} className="bg-blue-100 text-blue-700 px-3 py-1 rounded-full text-xs font-medium">
                                        {cert}
                                      </span>
                                    ))}
                                  </div>
